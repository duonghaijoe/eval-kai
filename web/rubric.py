...
DEFAULT_RUBRIC = {
    "turn_dimensions": {
        ...
        "latency": {
            ...
            "scores": {
                "1": "Very slow (TTFB >15s or total >40s)",
                "2": "Slow (TTFB >8s or total >20s)",
                "3": "Acceptable (TTFB >4s or total >10s)",
                "4": "Fast (TTFB >2s or total >5s)",
                "5": "Excellent (TTFB <2s and total <5s)",
            },
        },
    },
    "session_dimensions": {
