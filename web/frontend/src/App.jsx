      ...
      <div className="app">
        ...
        <main className="main">
          ...
          <footer className="app-footer">
            ...
            <span><Code size={12} style={{ verticalAlign: 'middle', marginRight: '0.3rem' }} />Test Kai — AI Agent Test Arena</span>
          </footer>
        </main>
        <AskJoePanel />
      </div>
